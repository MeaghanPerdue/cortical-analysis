...
for i in $(cat sublist2.txt); do
  for j in ${metricsleft[@]}; do
    # Left hemisphere
    mris_apply_reg --i /Users/meaghan/Projects/cortical-analysis/data/${i}/${j} \
      --o  /Users/meaghan/Projects/cortical-analysis/data/${i}/${j}.fsa6.mgz \
      --streg $SUBJECTS_DIR/fsaverage/surf/lh.sphere.reg $SUBJECTS_DIR/fsaverage6/surf/lh.sphere.reg 
    done
  for k in ${metricsright[@]}; do
    # Right hemisphere
    mris_apply_reg --i /Users/meaghan/Projects/cortical-analysis/data/${i}/${k} \
      --o  /Users/meaghan/Projects/cortical-analysis/data/${i}/${k}.fsa6.mgz \
